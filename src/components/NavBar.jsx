...
const NavBar = () => {
    return (
        <nav className="min-w-screen bg-gray-800 p-4 text-white flex justify-between mx-auto items-center">
            ...
            <div className="flex space-x-4 justify-center space-x-8">
                ...
                <Link to="/log" className="text-gray-400 hover:text-white mx-2 flex items-center gap-2 text-inherit no-underline">
